				...
				<th scope="col" class="manage-column column-label">
					<?php
						printf(
							...
							esc_html_x( 'Server %s', 'taxonomy name', 'capsule' ), esc_html( $tax_obj->labels->singular_name )
						);
					?>
				</th>
				<th scope="col" class="manage-column column-api-key">
					<?php
						printf(
							...
							esc_html_x( 'Local %s', 'taxonomy name', 'capsule' ), esc_html( $tax_obj->labels->singular_name )
						);
					?>
				</th>
			</tr>
